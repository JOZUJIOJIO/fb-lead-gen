...
${conversationRules || '[对话规则]'}`;
  ...
  const handleSubmit = async () => {
    ...
    try {
      // TODO: Call API
      // await personaApi.create({ name: personaName, company: { name: companyName, description: companyDesc, products }, salesperson: { name: salesName, title: salesTitle, personality: salesPersonality }, style: { tone, greeting_rules: greetingRules, conversation_rules: conversationRules } });
      console.log('Creating persona:', { personaName, companyName, companyDesc, products, salesName, salesTitle, salesPersonality, tone, greetingRules, conversationRules });
